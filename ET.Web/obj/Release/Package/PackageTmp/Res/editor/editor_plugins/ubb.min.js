...
b = b.replace(/\[flash\s*(?:=\s*(\d+)\s*,\s*(\d+)\s*)?\]\s*(((?!")[\s\S])+?)(?:"[\s\S]*?)?\s*\[\/flash\]/ig, function (b, a, c, e) { a || (a = 480); c || (c = 400); return '<embed type="application/x-shockwave-flash" src="' + e + '" wmode="opaque" quality="high" bgcolor="#ffffff" menu="false" play="true" loop="true" width="' + a + '" height="' + c + '"/>' }); b = b.replace(/\[media\s*(?:=\s*(\d+)\s*,\s*(\d+)\s*(?:,\s*(\d+)\s*)?)?\]\s*(((?!")[\s\S])+?)(?:"[\s\S]*?)?\s*\[\/media\]/ig, function (b, a, c, e, g) {
    a || (a = 480); c || (c = 400);
    return '<object id="player" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" name="player" width="' + a + '" height="' + c + '">	<param name="movie" value="mediaplayer/player.swf" /><param name="allowfullscreen" value="true" /><param name="allowscriptaccess" value="always" />        <param name="fullscreen" value="true" /><param name="flashvars" value="file=../' + g + '&image=mediaplayer/flv.gif&autostart=' + ("1" == e ? "true" : "false") + '" />		<object type="application/x-shockwave-flash" data="player.swf" width="' + a + '" height="' + c + '">			<param name="movie" value="mediaplayer/player.swf" />			<param name="allowfullscreen" value="true" />			<param name="allowscriptaccess" value="always" />			<param name="flashvars" value="file=../' + g + '&image=mediaplayer/flv.gif&autostart=' + ("1" == e ? "true" : "false") + '" />		</object>	</object>'




    //return '<embed type="application/x-mplayer2" src="' + g + '" enablecontextmenu="false" autostart="' + ("1" == e ? "true" : "false") + '" width="' + a + '" height="' + c + '"/>'
