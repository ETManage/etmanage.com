...
namespace ET.Web.Controllers
{
    ...
    using ET.Weixin.MP.CommonService;
    using ET.Weixin.MP.CommonService.CustomMessageHandler;
    ...
    public partial class WeixinController : Controller
    {
        ...
        public ActionResult Post(PostModel postModel)
        {
            ...
            var logPath = Server.MapPath(string.Format("~/Upload/Log/Weixin/{0}/", DateTime.Now.ToString("yyyy-MM-dd")));
            ...
            try
            {
                ...
                //测试时可开启此记录，帮助跟踪数据，使用前请确保Upload文件夹存在，且有读写权限。
