...
namespace ET.Weixin.MP.CommonService.CustomMessageHandler
{
    ...
    public partial class CustomMessageHandler
    {
        ...
        {
            return string.Format(@"欢迎关注【弈泰网络资讯平台】，您可以发送【文字】【位置】【图片】【语音】等不同类型的信息，获得更多经常内容！。

您还可以通过网页访问我们的博客平台，网址为http://etmanage.com/，更多劲爆精彩内容等您观看！
                ...
                case "SubClickRoot_Music":
                    {
                        ...
                        strongResponseMessage.Music.MusicUrl = "http://etmanage.com/upload/temp/music1.mp3";
                        strongResponseMessage.Music.HQMusicUrl = "http://etmanage.com/upload/temp/music1.mp3";
                ...
                case "SubClickRoot_Image":
                    {
                        ...
                        var uploadResult = Senparc.Weixin.MP.AdvancedAPIs.Media.MediaApi.UploadTemporaryMedia(accessToken, UploadMediaFileType.image,
                                                                     Server.GetMapPath("~/Images/logo64x64.png"));
                        //设置图片信息
                ...
                case "OAuth"://OAuth授权测试
                    {
                        ...
                        strongResponseMessage.Articles.Add(new Article()
                        {
                            ...
                            Url = "http://etmanage.com/weixin/oauth2",
                            PicUrl = "http://etmanage/Images/Blog/weixincode.jpg"
                        });
                        reponseMessage = strongResponseMessage;
                    }
                    break;
